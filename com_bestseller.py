...
for lv in range(1, 6, 1):
    ...
    wiki = "https://www.amazon.com/best-sellers-books-Amazon/zgbs/books/\
        ref=zg_bs_pg_" + str(lv) + "?_encoding=UTF8&pg=" + str(lv)
    ...
    for book in books:
        ...
        if url != []:
            for n in url:
                if flag == 0:
                    ur.append("https://www.amazon.com" + n.get("href"))
                    flag = 1
        else:
            if flag == 0:
...
print("Bestsellers from amazon.com scrapped !!")
